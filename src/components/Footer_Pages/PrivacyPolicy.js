...
function Privacy() {
  const styles = {
    ...
    container: {
      ...
      color: "#333",
      lineHeight: "1.6",
      backgroundColor: "#fff", // Optional: White background for the content
    ...
    <div style={styles.outerContainer}>
      <div style={styles.container}>
        ...
        <p>
          ...
          inquiries, fulfill requests, and provide updates on relevant courses
          and programs. Occasionally, we may send newsletters or promotional
          communications; however, you always have the option to opt out of such
          communications.
        </p>
        <p>
          You have full control over your personal information and can request
          to access, modify, or delete it at any time. Should you wish to update
          your details or remove your information from our records, please
          contact us directly. You can also unsubscribe from promotional emails
        ...
        <p>
          ...
          exclusive property of their respective universities. Distance
          Education Center is not authorized to issue any university-affiliated
          documents.
        </p>
      </div>
    </div>
